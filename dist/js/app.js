...
app.config(function($stateProvider, $httpProvider, FluroProvider, $urlRouterProvider, $locationProvider, $analyticsProvider) {
    ...
    $scope.event = event, $localStorage.checklistSearch ? $scope.search = $localStorage.checklistSearch : $scope.search = $localStorage.checklistSearch = {
        terms: ""
    }, $scope.report = {
        items: []
